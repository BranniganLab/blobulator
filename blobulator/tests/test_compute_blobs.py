...
def test_min_blob_hydropathy(current_blobulation, previous_blobulator_output):
    ...
    assert current_blobulation["Min_Blob_Hydropathy"].eq(previous_blobulator_output["Min_Blob_Hydropathy"])
...
def test_blob_index_number(current_blobulation, previous_blobulator_output):
    ...
    assert current_blobulation["Blob_Index_Number"].eq(previous_blobulator_output["Blob_Index_Number"])
...
def test_blob_ncpr(current_blobulation, previous_blobulator_output):
    ...
    assert current_blobulation["Blob_NCPR"].eq(previous_blobulator_output["Blob_NCPR"])
...
def test_blob_dsnp_enrichment(current_blobulation, previous_blobulator_output):
    ...
    assert current_blobulation["dSNP_enrichment"].eq(previous_blobulator_output["dSNP_enrichment"])
...
def test_blob_daspappu(current_blobulation, previous_blobulator_output):
    ...
    assert current_blobulation["Blob_Das-Pappu_Class"].eq(previous_blobulator_output["Blob_Das-Pappu_Class"])
...
def test_blob_uversky(current_blobulation, previous_blobulator_output):
    ...
    assert current_blobulation["Uversky_Diagram_Score"].eq(previous_blobulator_output["Uversky_Diagram_Score"])
...
def test_smoothed_hydropathy(current_blobulation, previous_blobulator_output):
    ...
    assert current_blobulation["Smoothed_Hydropathy"].eq(previous_blobulator_output["Smoothed_Hydropathy"])
